            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                        ...
                        <div class="col-md-6 col-xs-12">
                            ...
                            @if(count($ressources)>1)
                                <div class="col-xs-12">
                                    ...
                                    {{ Form::checkbox('rooms[]', $ressource->id, $ressource->id == $booking_item->ressource_id, array('id'=> sprintf('meeting-add-room%d', $ressource->id))) }}
                                            &nbsp;
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ URL::route('booking_with_date', array('now'=> date('Y-m-d', strtotime($booking_item->start_at)))) }}" class="btn btn-white">Annuler</a>
                    </div>
                    {{ Form::close() }}
                </div>
            </div>
