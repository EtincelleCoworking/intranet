...
class SubscriptionKind extends Eloquent
{
    ...
    {
        return self::ShortNameAttribute($this->name);
    }

    public static function ShortNameAttribute($value)
    {
        return str_replace(array('Coworking - ', ' - %UserName%', 'Abonnement '), array('', '', ''), $value);
    }
