				...
				<div id="navbar" class="collapse navbar-collapse">
					...
					<ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ URL::route('ressource_list') }}">Liste</a></li>
                                <li><a href="{{ URL::route('ressource_add') }}">Ajouter une ressource</a></li>
                            </ul>
                        </li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Pays <span class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="{{ URL::route('country_list') }}">Liste</a></li>
								<li><a href="{{ URL::route('country_add') }}">Ajouter un pays</a></li>
							</ul>
						</li>
					</ul>
					@endif
