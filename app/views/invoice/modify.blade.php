...
@section('content')
    <div class="pull-right">
        <a href="{{ URL::route('invoice_print_pdf', $invoice->id) }}" class="btn btn-sm btn-primary"
           target="_blank">PDF</a>
    </div>
    ...
    <table class="table table-striped table-hover">
        ...
        @foreach ($invoice->items as $item)
            <tr>
                ...
                <td><a href="{{ URL::route('invoice_item_delete', array($invoice->id, $item->id)) }}"
                       data-method="delete" data-confirm="Etes-vous certain de vouloir retirer cette ligne ?"
                       rel="nofollow">Retirer</a</td>
            </tr>
        @endforeach
        </tbody>
        <tfoot>
        ...
        <div class="row">
            <div class="col-md-4" align="center">
                <a href="{{ URL::route('invoice_validate', $invoice->id) }}" data-method="get"
                   data-confirm="Etes-vous certain de vouloir passer ce devis en facture ?" rel="nofollow"
                   class="btn btn-success">Passer en facture</a>
            </div>
            <div class="col-md-4" align="center">
                <a href="{{ URL::route('invoice_cancel', $invoice->id) }}" data-method="get"
                   data-confirm="Etes-vous certain de vouloir passer ce devis en refusé ?" rel="nofollow"
                   class="btn btn-warning">Devis refusé</a>
            </div>
            <div class="col-md-4" align="center">
