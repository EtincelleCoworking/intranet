...
@section('content')
    ...
    <div class="row">
        ...
        @if (Auth::user()->role == 'superadmin')
            <div class="col-md-6">
                ...
                <p>{{ Form::select('invoice_id', Invoice::Select('Sélectionnez une facture'), $time->invoice_id, array('class' => 'form-control')) }}</p>
            </div>
        @else
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p>{{ Form::text('comment', $time->comment, array('class' => 'form-control')) }}</p>
        </div>
    </div>
