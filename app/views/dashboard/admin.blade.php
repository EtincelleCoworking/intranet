                ...
                @foreach($datas as $location => $location_datas)
                    ...
                    @if(isset($ressources[$location]))
                        <tr>
                            <td colspan="4">
                                <table class="table">
                                    @foreach($ressources[$location] as $ressource_id => $ressource_name)
                                        <?php
                                        ...
                                        ?>
                                        <tr>
                                            <td class="col-md-6">{{ $ressource_name }}</td>
                                            <td class="col-md-3">
                                                <div class="progress">
...
@endif
                                            ...
                                            --}}
                                            <td class="col-md-3" style="text-align:right">{{ number_format($data->amount, 0, ',', '.') }}
                                                € HT
                                            </td>
                                        </tr>
                                    @endforeach
