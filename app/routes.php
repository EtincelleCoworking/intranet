...
Route::get('/api/2025/booking//booking/availability', array('uses' => 'Api2025Controller@booking_availability'));
...
Route::post('/api/1.0/invoices', array('uses' => 'ApiController@make_invoice'));
...
Route::group(['before' => 'superadmin'], function() {
	...
	Route::get('/invoice/coworking_pending', array('as' => 'invoice_coworking_pending', 'uses' => 'InvoiceController@coworking_pending'));
